...
const DetailCategory = () => {
  ...
  return (
    <View style={styles.detailcategory}>
      <Image
        style={styles.detailcategoryChild}
        contentFit="cover"
        source={require("../assets/vector-6.png")}
      />
      <Text style={styles.title}>Olahraga</Text>
      <Pressable
        style={[styles.eventitem, styles.eventitemLayout]}
      ...
      <View style={[styles.navbar, styles.navbarLayout]}>
        ...
        <View style={[styles.categories, styles.categoriesPosition]}>
          <Text style={[styles.supportingText47, styles.categoriesPosition]}>
            Categories
          </Text>
          <Image
        ...
        >
          <Text style={[styles.supportingText48, styles.homePosition]}>
            Home
          </Text>
          <Image

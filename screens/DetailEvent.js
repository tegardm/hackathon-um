  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.detailsContainer}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('ListedUMKM',{idEvent:uid, dataUMKM:eventDetails.dataUMKM})} style={styles.button} >
            <Text style={styles.buttonText}>Lihat List UMKM Terdaftar ({eventDetails.dataUMKM.length}/{eventDetails.maxUMKM})</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
      <View style={styles.buttonContainer}>
        ...
        <>
        { userData && eventDetails && auth.currentUser.uid != eventDetails.authorId && userData.HaveUMKM == true ? (
          <>
